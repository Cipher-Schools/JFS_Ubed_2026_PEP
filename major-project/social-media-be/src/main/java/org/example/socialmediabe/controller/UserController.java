...
public class UserController {
    ...
    @GetMapping("/{username}")
    public ResponseEntity<ApiResponse<UserResponse>> getUserByUsername(@PathVariable String username) { // @PathVariable extracts username from URL path
        ...
        return ResponseEntity.status(HttpStatus.OK)
                .body(ApiResponse.success("User fetched successfully", new UserResponse(fetchedUser)));
    }
